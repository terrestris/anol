...
import templateHTML from './templates/print.html';
            ...
            return {
                ...
                link: {
                    pre: function (scope, element, attrs) {
                        ...
                        const prepareOverlays = function (layers) {
                            let _layers = [];
                            angular.forEach(layers, function (layer) {
                                if (layer instanceof anol.layer.Group) {
                                    _layers = _layers.concat(prepareOverlays(layer.layers.slice()));
                                } else {
                                    if (layer.getVisible()) {
                                        _layers.push(layer);
                                    }
                        ...
                        scope.startPrint = function () {
                            ...
                            let layers = [LayersService.activeBackgroundLayer()];
                            ...
                            const downloadPromise = PrintService.startPrint({
                            ...
                            downloadPromise.then(
                                function (response) {
                                    const downloadLink = element.find('.download-link');
                        ...
                        scope.setPageLayout = function (size, layout) {
                            ...
                            const errors = PrintPageService.getSizeErrors(scope.printAttributes.pageSize);
